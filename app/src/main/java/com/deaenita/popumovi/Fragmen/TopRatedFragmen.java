 ...
 */
public class TopRatedFragmen extends Fragment {

    public TopRatedFragmen(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmenView = inflater.inflate(R.layout.fragment_top_rated, container, false);
...
//        }
    ...
    private void ambilTopRate() {
        ...
        Call<ListMovieModel> call = api.ambilTopRate();
